...
instr 1000  ; this instrument sends OSC-values
        ...
        OSCsend   kValue1+kValue2, $IPADDRESS, $S_PORT, "/CsoundQt", "fff", kValue1, kValue2, kValue3
endin
...
instr 1001  ; this instrument receives OSC-values       
        ...
        kAction  OSClisten      ihandle, "/CsoundQt", "fff", kValue1Received, kValue2Received, kValue3Received
                if (kAction == 1) then  
