...
ioText {16, 55} {273, 155} display 0.000000 0.00100 "" left "Arial" 12 {0, 0, 0} {59392, 59392, 59392} nobackground noborder The widget panel contains widgets which can interact with Csound. It has two modes: an action mode and an edit mode. In the action mode widgets are used to send and receive values from Csound channels and can be modified using the mouse or the keyboard. In edit mode the widgets can be moved resized copied dupicated and pasted.
ioText {162, 218} {243, 126} display 0.000000 0.00100 "" left "Arial" 12 {0, 0, 0} {59392, 59392, 59392} nobackground noborder The modes are toggled using Ctrl+E or Command+E. When in edit mode red frames appear around every widget. Using these frames widgets can be moved and resized. You can also copy paste and duplicate widgets.
ioKnob {297, 49} {51, 53} 1.000000 0.000000 0.010000 0.262626 knob3
ioText {298, 109} {100, 26} editnum 4502.010000 0.001000 "" left "" 0 {0, 0, 0} {59392, 59392, 59392} nobackground noborder 4502.010000
ioButton {298, 140} {100, 30} event 1.000000 "button1" "New Button" "/" i1 0 10
ioMenu {298, 176} {80, 26} 1 303 "item1,item2,item3" menu6
ioText {42, 219} {105, 43} scroll 55.000000 1.000000 "scroll1" center "Courier New" 40 {65280, 65280, 65280} {10240, 20224, 12544} background noborder 40.00000000
ioMeter {41, 269} {107, 73} {0, 59904, 0} "scroll1" 55.000000 "slider1" 39.843750 crosshair 1 0 mouse
ioText {16, 356} {292, 126} display 0.000000 0.00100 "" left "Arial" 12 {0, 0, 0} {59392, 59392, 59392} nobackground noborder Widget properties can be accessed by right clicking on the widget and selecting 'Properties'. This works on both modes. Properties are different for every widget. If you right click where there are no widgets, you can set the Widget Panel's background color.
ioCheckbox {321, 362} {20, 20} on checkbox10
ioText {319, 387} {87, 25} edit 0.000000 0.00100 ""  "Arial" 12 {0, 0, 0} {65280, 65280, 65280} falsenoborder Type here
ioText {16, 493} {388, 41} display 0.000000 0.00100 "" left "Times New Roman" 12 {0, 0, 0} {59392, 59392, 59392} nobackground noborder Note that none of the widgets shown here have effect since their channels are not being used by Csound.
