...
ioText {14, 12} {209, 38} label 0.000000 0.00100 "" left "Helvetica" 26 {61696, 61696, 61696} {65280, 65280, 65280} nobackground noborder Using Widgets
ioText {14, 50} {363, 106} label 0.000000 0.00100 "" left "Helvetica" 14 {61696, 61696, 61696} {65280, 65280, 65280} nobackground noborder You can receive Widget values in the Csound orchestra using "channels". You use channel names to identify them, and you must set the channel name in the Widget and in the orchestra's invalue opcode.
ioText {15, 320} {364, 49} label 0.000000 0.00100 "" left "Helvetica" 14 {61696, 61696, 61696} {65280, 65280, 65280} nobackground noborder Now run Csound, and notice how the widget is controlling the frequency of the oscillator!
ioText {12, 184} {368, 101} label 0.000000 0.00100 "" left "Helvetica" 14 {61696, 61696, 61696} {65280, 65280, 65280} nobackground noborder Enter the slider's properties by right-clicking (or control-clicking) and selecting "Properties". This will open the Widget Properties dialog, which will allow you to set the Widget's channel name. Set the channel name to "freq" (without the quotes).
ioSlider {13, 160} {366, 21} 300.000000 1000.000000 300.000000 slider
ioText {12, 409} {372, 51} label 0.000000 0.00100 "" left "Helvetica" 14 {61696, 61696, 61696} {65280, 65280, 65280} nobackground noborder You can change a slider's range in its properties dialog, if you want a broader or smaller range.
</MacGUI>
