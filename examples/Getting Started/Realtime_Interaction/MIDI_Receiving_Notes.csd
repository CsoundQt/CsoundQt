...
Without modification, the MIDI-Channel-Number selects the Csound Instrument Number.  To route the desired MIDI-information (note-number and velocity) to the p-arguments (4 and 5), it will be defined in CsOptions:
