...
instr	2	;INIT
		...
		outvalue	"dettack",	.34
		outvalue	"NumbGrooves",	128
		outvalue	"Damping",	.47
		outvalue	"EnergyFB",	0
		outvalue	"Freq",		0.685
		outvalue	"Freq1",		0.812
		endin
</CsInstruments>
<CsScore>
...
<bsbPanel>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>Number of Grooves (i-rate)</label>
  <alignment>left</alignment>
  <font>Liberation Sans</font>
  <fontsize>10</fontsize>
  <precision>3</precision>
 ...
 <bsbObject version="2" type="BSBHSlider">
  <objectName>NumbGrooves</objectName>
  <x>8</x>
  <y>124</y>
  <width>500</width>
  <height>27</height>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midicc>0</midicc>
  <label>----------------------------------------------------------------
guiro is a semi-physical model of a guiro.
...
Note that the opcode needs to be 're-scraped' in order to hear the changes made to i-rate controls.</label>
  <alignment>left</alignment>
  <font>Liberation Sans</font>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>220</width>
  <height>30</height>
  <uuid>{e3593047-b918-47fd-9b98-ca66cd26153a}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
 ...
 <bsbObject version="2" type="BSBHSlider">
  ...
  <width>500</width>
  <height>27</height>
  <uuid>{691ea192-07c8-485d-a30c-f901bcede5a7}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <minimum>0.00000000</minimum>
 ...
 <bsbObject version="2" type="BSBDisplay">
  ...
  <width>60</width>
  <height>30</height>
  <uuid>{555e61df-11eb-4ed6-b2e7-b1a5c2dfb3d4}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>1984.061</label>
  <alignment>right</alignment>
  <font>Liberation Sans</font>
  <fontsize>9</fontsize>
  <precision>3</precision>
