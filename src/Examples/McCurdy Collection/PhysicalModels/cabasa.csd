...
<bsbPanel>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>Number of Beads (i-rate)</label>
  <alignment>left</alignment>
  <font>Liberation Sans</font>
  <fontsize>10</fontsize>
  <precision>3</precision>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midicc>0</midicc>
  <label>---------------------------------------------------------------------------------------------------------------
'cabasa' is a semi-physical model of a cabasa sound. It is one of the PhISEM percussion opcodes. PhISEM (Physically Informed Stochastic Event Modeling) is an algorithmic approach for simulating collisions of multiple independent sound producing objects. A cabasa is a small textured metal cylinder around which chains of small metal beads are attached. It is normally played by rotating a handle attached to the drums whilst preventing the chains from also rotating by holding the hand against them. As the beads rub against the textured surface of the cylinder they produce a grating sound. The input parameter 'idettack' which is supposed to control the time until all sound ceases doens't seem to have any effect. If 'Energy Feedback' is anything other than zero a sustained texture is produced. 'Damping' gives some control over how the density of the sound decays.</label>
  <alignment>left</alignment>
  <font>Liberation Sans</font>
