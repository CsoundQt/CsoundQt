...
givfn	ftgen	0, 0, 256, 10, 1						;VIBRATO WAVEFORM (A SINE WAVE)
giExp1	ftgen	0, 0, 129, -25, 0, 20.0, 128, 20000.0		;TABLE FOR EXP SLIDER
giExp2	ftgen	0, 0, 129, -25, 0, 0.0001, 128, 2.0		;TABLE FOR EXP SLIDER
...
instr	10	;GUI
	...
	if (ktrig == 1)	then
		...
		gktens		invalue	"Tension"
		katt			invalue	"Attack"
		gkatt		tablei	katt, giExp2, 1
...
instr	2	;INIT
			...
			outvalue	"Tension"	, 0.4
			outvalue	"Attack"	, 0.46
			outvalue	"VibFreq"	, 5.0
			outvalue	"VibAmp"	, 0.01
endin
</CsInstruments>
<CsScore>
...
<bsbPanel>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midicc>0</midicc>
  <label>--------------------------------------------------------------
'wgbrass' creates a physical model of a brass instrument.
It seems rather unstable. Experimentation with the settings for 'Frequency' and 'Lip Tension' are sometimes required in order to get the instrument to sound.
Perhaps it will be improved in future releases of Csound.</label>
  <alignment>left</alignment>
  <font>Liberation Sans</font>
