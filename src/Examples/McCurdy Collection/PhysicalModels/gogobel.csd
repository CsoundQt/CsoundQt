...
;	Add Browser for impulse file, accept mono or stereo wav files
...
instr	1	;MIDI ACTIVATED INSTRUMENT
	...
	UPDATE:
	ares 	gogobel 	iamp, ifreq, i(gkhrd), i(gkpos), gimp, gkvibf, gkvamp, givfn
			rireturn
...
instr	3
	...
	UPDATE:
	ares 	gogobel 	i(gkamp), i(gkfreq), i(gkhrd), i(gkpos), gimp, gkvibf, gkvamp, givfn
			rireturn
			outs 	ares, ares
endin
...
<bsbPanel>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midicc>0</midicc>
  <label>----------------------------------------------------------------
'gogobel' is a physical model of a cow bell or agogo bell. 'Stick Hardness' and 'Strike Position' impact some variation in tone but this is quite subtle. It is difficult to imagine why vibrato has been included in an emulation of a cow bell. It is actually difficult to experience the vibrato as the duration of the sound is so short.
By replacing the sample suggested for the strike impulse (marmstk1.wav) with a longer sample (for example bounce.wav), a longer duration tone is possible.
