...
;	Instrument 1 is activated by MIDI and by the GUI (with lost of midi portamento, sorry !!!, fofx6_Mono have it!)
...
;	                         FOF x 6                             
;	--------------------------------------------------------------------------------------------------------------------------
;	This example make use of six simultaneous instances of the opcode to imitate a variety of singing voices singing various
;	vowel sounds.
;	The interface allows a variety of methods for inputting the essential parameter values and the patch incorporates several
;	additional effects and elaborations.
;	The first method for parameter input is 'Sliders or MIDI'. To use sliders, first activate the main 'On/Off' button which
;	then allows control of the fundamental of the tone using the 'Fundemental (Hz)' slider and of the vowel using the
;	'A E I O U' slider. To use MIDI just leave the main 'On/Off' button deactivated and play notes on the MIDI keyboard. The
;	instrument is polyphonic.
;	MIDI continuous controller 2 can be used to modulate the vowel type produced and controller 1 controls vibrato depth.
;	The second method for parameter input is 'XY Panel'. With this method activated, fundamental and vowel type of the tone
;	are controllable using the XY panel at the bottom of the interface. Movement in the vertical plane varys the
;	fundemental and movement in the horizontal plane vary the vowel type.
;	Selecting the 'Counters' option for parameter input mode allows the fundamental to be defined using the two
;	neighbouring counters. In this mode, vowel type is varyed using the slider.
...
giExp10_2000	ftgen	200, 0, 129, -25, 0,  10.0, 128,  2000.0		;TABLE FOR EXP SLIDER
giExp1_3000	ftgen	201, 0, 129, -25, 0,   1.0, 128,  3000.0		;TABLE FOR EXP SLIDER
...
instr	10	;GUI
	ktrig	metro	10
	if (ktrig == 1)	then
		gkOctave		invalue	"Octave"
		gkSemiStep	invalue	"SemiStep"
		gkIPmode		invalue	"IPmode"
		gkvoice		invalue	"Voice"
		gkLFOmode		invalue	"LFOmode"

		gkndx		invalue	"A_E_I_O_U"				;MIDI CC 1
		kfund		invalue	"Fundamental"
		gkfund		tablei	kfund, giExp1_3000, 1
					outvalue	"Fundamental_Value", gkfund
		...
		kfund2		invalue	"X_Fund"
		gkfund2		tablei	kfund2, giExp10_2000, 1
					outvalue	"X_Fund_Value", gkfund2
		gkndx2		invalue	"Y_Vowel"
	endif
endin

instr	1	;FOF INSTRUMENT
	if p4!=0 then													;MIDI
...
<bsbPanel>
 ...
 <bsbObject version="2" type="BSBController">
  ...
  <midichan>0</midichan>
  <midicc>0</midicc>
  <objectName2>Y_Vowel</objectName2>
  <xMin>0.00000000</xMin>
  <xMax>1.00000000</xMax>
  <yMin>0.00000000</yMin>
  <yMax>1.00000000</yMax>
  <xValue>0.41981132</xValue>
  <yValue>0.88214286</yValue>
  <type>crosshair</type>
 ...
 <bsbObject version="2" type="BSBDisplay">
  <objectName>Fundamental_Value</objectName>
  <x>448</x>
  <y>106</y>
  <width>60</width>
  <height>30</height>
 ...
 <bsbObject version="2" type="BSBHSlider">
  <objectName>Fundamental</objectName>
  <x>8</x>
  <y>83</y>
  <width>500</width>
  <height>27</height>
 ...
 <bsbObject version="2" type="BSBKnob">
  ...
  <width>50</width>
  <height>50</height>
  <uuid>{eab840b1-ef80-44a1-b200-ba637f797e6b}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <minimum>0.00000000</minimum>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>140</width>
  <height>32</height>
  <uuid>{67a2a15f-e739-4b8b-80ed-77f309ecbb1a}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
 ...
 <bsbObject version="2" type="BSBDisplay">
  ...
  <width>65</width>
  <height>31</height>
  <uuid>{f08bb192-4689-46b3-bdfe-d32a9bb975e3}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>0.000</label>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>310</width>
  <height>80</height>
  <uuid>{a14a1ff5-c12f-4a46-b765-ca80de5f1af4}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>Fundamental and Vowel Input Mode</label>
  <alignment>left</alignment>
  <font>Liberation Sans</font>
  <fontsize>14</fontsize>
  <precision>3</precision>
 ...
 <bsbObject version="2" type="BSBDropdown">
  <objectName>IPmode</objectName>
  <x>540</x>
  <y>662</y>
  <width>130</width>
  <height>28</height>
  <uuid>{95b54950-7db4-4e85-8acb-56b5f87e0093}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <bsbDropdownItemList>
   <bsbDropdownItem>
    <name>Sliders or MIDI</name>
    <value>0</value>
    <stringvalue/>
   </bsbDropdownItem>
   <bsbDropdownItem>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>60</width>
  <height>30</height>
  <uuid>{0409f8c9-7ca8-4cac-a943-c1bc8f76b0fb}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>Octave</label>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>80</width>
  <height>30</height>
  <uuid>{e22fab78-fcca-42ed-a56f-1ed7b787d31d}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
 ...
 <bsbObject version="2" type="BSBSpinBox">
  ...
  <width>50</width>
  <height>25</height>
  <uuid>{35b345d5-a100-4eeb-96ce-11bb13805fa2}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <alignment>center</alignment>
 ...
 <bsbObject version="2" type="BSBSpinBox">
  <objectName>SemiStep</objectName>
  <x>764</x>
  <y>664</y>
  <width>50</width>
  <height>25</height>
  <uuid>{7d58a22e-fe0e-4e16-98f9-cc8c948d9da0}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <alignment>center</alignment>
...
<value id="{2fef8117-9c62-4419-b6e0-45ef9c15647f}" mode="1" >0.43632075</value>
<value id="{2fef8117-9c62-4419-b6e0-45ef9c15647f}" mode="2" >1.00000000</value>
...
<value id="{3be43919-ad18-4aef-b554-03c4b4d991c3}" mode="1" >100.69047546</value>
<value id="{3be43919-ad18-4aef-b554-03c4b4d991c3}" mode="4" >100.690</value>
<value id="{eac88081-deaa-45c0-b896-32a3ffedc74a}" mode="1" >0.57599998</value>
<value id="{6aac1f5d-f8dd-4e66-a987-3203fd01550f}" mode="1" >100.93327332</value>
<value id="{6aac1f5d-f8dd-4e66-a987-3203fd01550f}" mode="4" >100.933</value>
<value id="{ee3fa20e-dea1-4af9-97d7-f7ba52bdd47c}" mode="1" >1.00000000</value>
<value id="{ee3fa20e-dea1-4af9-97d7-f7ba52bdd47c}" mode="4" >1.000</value>
...
<value id="{eab840b1-ef80-44a1-b200-ba637f797e6b}" mode="1" >0.00000000</value>
<value id="{f08bb192-4689-46b3-bdfe-d32a9bb975e3}" mode="1" >0.00000000</value>
<value id="{f08bb192-4689-46b3-bdfe-d32a9bb975e3}" mode="4" >0.000</value>
...
<value id="{95b54950-7db4-4e85-8acb-56b5f87e0093}" mode="1" >0.00000000</value>
<value id="{35b345d5-a100-4eeb-96ce-11bb13805fa2}" mode="1" >7.00000000</value>
<value id="{7d58a22e-fe0e-4e16-98f9-cc8c948d9da0}" mode="1" >0.00000000</value>
</preset>
</bsbPresets>
