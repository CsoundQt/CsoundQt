...
;	Add Browser for audio files, use stereo sound wav files.
...
instr	1
	...
	if gkinput=0 then
		...
		NEW_FILE1:
		aasigL, aasigR	diskin2	Sfile1, 1, 0, 1
		rireturn
	endif
	...
	if gkdetect=0 then
		...
		NEW_FILE2:
		acsigL, acsigR	diskin2	Sfile2, 1, 0, 1
		rireturn
	endif
...
<value id="{b9431a61-61f7-432b-bf6f-c47ddc7f9050}" mode="4" >/home/moi/Samples/synthpad.wav</value>
<value id="{68b5f90b-b78e-4581-b434-232db5f4c40f}" mode="4" >/home/moi/Samples/synthpad.wav</value>
...
<value id="{fd6d018b-1bcd-43b4-88e9-f240b379d7d0}" mode="4" >/home/moi/Samples/808loop.wav</value>
<value id="{8616b387-3762-43e0-9492-10006eb9c01f}" mode="4" >/home/moi/Samples/808loop.wav</value>
...
<value id="{5d1ba94c-536a-4178-be6c-c0d9d2f75e3d}" mode="1" >5.00666571</value>
...
<value id="{df4e20a1-b9a6-46ca-bb02-911779f6b4b5}" mode="1" >0.09956782</value>
...
<value id="{9481489d-99dd-43af-8282-21a31584dd71}" mode="1" >1.52186513</value>
...
<value id="{5d1ba94c-536a-4178-be6c-c0d9d2f75e3d}" mode="1" >0.65612739</value>
...
<value id="{9481489d-99dd-43af-8282-21a31584dd71}" mode="1" >0.01008262</value>
...
<value id="{5d1ba94c-536a-4178-be6c-c0d9d2f75e3d}" mode="1" >1.00625730</value>
...
<value id="{df4e20a1-b9a6-46ca-bb02-911779f6b4b5}" mode="1" >0.09817591</value>
...
<value id="{9481489d-99dd-43af-8282-21a31584dd71}" mode="1" >1.38890862</value>
...
<value id="{9481489d-99dd-43af-8282-21a31584dd71}" mode="1" >1.45400369</value>
