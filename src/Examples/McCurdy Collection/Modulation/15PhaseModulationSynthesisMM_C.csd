...
;	Cannot display more than one space in Label, so can't display the schematic shown below:
	...
	;Phase Modulation Synthesis: 2 parallel modulators -> carrier
	;-------------------------------------------------------------
...
instr	1	;FM INSTRUMENT
	...
	iporttime		=		.025										;PORTAMENTO FUNCTION (WILL BE USED TO SMOOTH PARAMETER MOVED BY WIDGETS)
...
i 10		0	   3600		;GUI
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midicc>0</midicc>
  <label>--------------------------------------------------------------------
An implementation of phase modulation synthesis with two parallel modulators modulating a single carrier.
</label>
...
Frequency</label>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>2 parallel modulators -> carrier</label>
  <alignment>center</alignment>
  <font>Liberation Sans</font>
  <fontsize>18</fontsize>
  <precision>3</precision>
