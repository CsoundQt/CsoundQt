...
;	Cannot display more than one space in Label, so can't display the schematic shown below:
	...
	;Phase Modulation Synthesis: mod.1->mod.2->mod.3->carrier
	;-----------------------------------------------------------
...
i 4 		0		3600		;AUDIO OUTPUT
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midicc>0</midicc>
  <label>--------------------------------------------------------------------
An implementation of phase modulation synthesis in which modulator 1 modulates modulator 2 which modulates modulator 3 which modulates a carrier.
</label>
...
Frequency</label>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>mod 1->mod 2->mod 3->carrier</label>
  <alignment>center</alignment>
  <font>Liberation Sans</font>
  <fontsize>18</fontsize>
  <precision>3</precision>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>180</width>
  <height>30</height>
  <uuid>{bf2efb39-a49c-4d0f-a91e-0527c9ac6ae2}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
 ...
 <bsbObject version="2" type="BSBHSlider">
  ...
  <width>500</width>
  <height>27</height>
  <uuid>{cbcc2cef-6d42-4543-9caa-78f141e5ca25}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <minimum>0.00000000</minimum>
 ...
 <bsbObject version="2" type="BSBDisplay">
  ...
  <width>60</width>
  <height>30</height>
  <uuid>{e40c117a-9d18-4e7e-8eca-c5a9503c3795}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>0.100</label>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>32</width>
  <height>46</height>
  <uuid>{f67b7c6a-a677-4fa1-9e95-8513a068ae14}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>:</label>
 ...
 <bsbObject version="2" type="BSBSpinBox">
  ...
  <width>80</width>
  <height>28</height>
  <uuid>{bdae4410-fc77-4bdb-af22-48fe99214e74}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <alignment>left</alignment>
...
<value id="{745d6bee-b951-4a03-9fe8-9e10d5ae4556}" mode="1" >0.19800000</value>
<value id="{745d6bee-b951-4a03-9fe8-9e10d5ae4556}" mode="4" >0.198</value>
<value id="{06814721-6151-4baa-84e2-8f39843b07a4}" mode="1" >0.19800000</value>
<value id="{6f8fc775-201d-40f9-931b-687c9b3ef417}" mode="1" >7.00000000</value>
<value id="{fd4b783c-f008-4a1c-b2e6-50340aad9093}" mode="1" >11.00000000</value>
<value id="{eac88081-deaa-45c0-b896-32a3ffedc74a}" mode="1" >0.10200000</value>
<value id="{3be43919-ad18-4aef-b554-03c4b4d991c3}" mode="1" >40.46354675</value>
<value id="{3be43919-ad18-4aef-b554-03c4b4d991c3}" mode="4" >40.464</value>
<value id="{9cf53cef-488f-4075-b87f-dc2c3e6a21e6}" mode="1" >0.20000000</value>
<value id="{c03c8ac7-b287-4328-8e07-bbf81f16291a}" mode="1" >0.10000000</value>
<value id="{c03c8ac7-b287-4328-8e07-bbf81f16291a}" mode="4" >0.100</value>
<value id="{9e41022a-6d97-415e-82ef-dafd223f6de8}" mode="1" >0.10000000</value>
<value id="{4613a393-76fd-495c-8e3b-95f1257e8326}" mode="1" >13.00000000</value>
<value id="{eb489cb5-93a5-43ca-bd05-14ec2a67e140}" mode="1" >0.20000000</value>
<value id="{eb489cb5-93a5-43ca-bd05-14ec2a67e140}" mode="4" >0.200</value>
<value id="{9d01a407-9af0-4e24-a903-b4f08bce805b}" mode="1" >0.00320000</value>
<value id="{f9c26af6-6311-452e-9cd9-51e286efef9a}" mode="1" >0.00320000</value>
<value id="{f9c26af6-6311-452e-9cd9-51e286efef9a}" mode="4" >0.003</value>
...
<value id="{cbcc2cef-6d42-4543-9caa-78f141e5ca25}" mode="1" >0.10000000</value>
<value id="{e40c117a-9d18-4e7e-8eca-c5a9503c3795}" mode="1" >0.10000000</value>
<value id="{e40c117a-9d18-4e7e-8eca-c5a9503c3795}" mode="4" >0.100</value>
<value id="{bdae4410-fc77-4bdb-af22-48fe99214e74}" mode="1" >1.00000000</value>
</preset>
</bsbPresets>
