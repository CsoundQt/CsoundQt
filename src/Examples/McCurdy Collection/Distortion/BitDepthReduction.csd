...
;	Add Browser for audio file(s) and use of FilePlay2 udo, now accept mono or stereo wav files
...
The example is designed to work with 16 bit samples but could easily be adapted to work with samples of other depths.</label>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>330</width>
  <height>30</height>
  <uuid>{3a95a5aa-102a-4b22-aac4-64e4a6c4f09f}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>Restart the instrument after changing the audio file.</label>
