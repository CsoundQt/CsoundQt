...
giExp1024		ftgen	0, 0, 129, -25, 0, 1.0, 128, 1024.0
...
instr	1	;GUI
	ktrig	metro	10
	if (ktrig == 1)	then
		kincr	invalue	"Foldover"
		gkincr	tablei	kincr, giExp1024, 1
				outvalue	"Foldover_Value", gkincr		;init 1.0
...
instr 2
	if	gkinput=0	then										;CHECK STATUS OF gkinput
		...
		asig, asigR	FilePlay2	Sfile1, 1, 0, 1				;READ IN SOUND FILE FROM DISK
	elseif		gkinput=1	then								;CHECK STATUS OF gkinput
		Sfile2	invalue	"_Browse2"
		asig, asigR	FilePlay2	Sfile2, 1, 0, 1				;READ IN SOUND FILE FROM DISK
...
<bsbPanel>
 ...
 <bsbObject version="2" type="BSBHSlider">
  <objectName>Foldover</objectName>
  <x>8</x>
  <y>47</y>
  <width>500</width>
  <height>27</height>
 ...
 <bsbObject version="2" type="BSBDisplay">
  <objectName>Foldover_Value</objectName>
  <x>448</x>
  <y>64</y>
  <width>60</width>
  <height>30</height>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midicc>0</midicc>
  <label>------------------------------------------------------------
The opcode 'fold' adds artificial foldover to an audio signal. This gives the effect of downsampling the audio signal to a lower sampling rate. Without interpolating between audio samples this produces a distinctive degrading of of the signal.
The amount of foldover is expressed as a multiple of the sampling rate therefore a value of 1 will produce no foldover, avalue of 2 will produce the effect of downsampling to 22050Hz (from 44100), a value of 4 will produce the effect of downsampling to 11025 and so on.</label>
  <alignment>left</alignment>
  <font>Liberation Sans</font>
 ...
 <bsbObject version="2" type="BSBDropdown">
  ...
  <width>100</width>
  <height>30</height>
  <uuid>{97bfdd5d-a6c2-4606-83c9-22dfe1c9f751}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <bsbDropdownItemList>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>60</width>
  <height>30</height>
  <uuid>{1ee229f8-de85-4323-a7dc-c390e0bbce97}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>Input</label>
 ...
 <bsbObject version="2" type="BSBButton">
  ...
  <width>170</width>
  <height>30</height>
  <uuid>{b411f2ac-0923-448a-8775-80459ac1e64b}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <type>value</type>
 ...
 <bsbObject version="2" type="BSBLineEdit">
  ...
  <width>330</width>
  <height>28</height>
  <uuid>{9553cd40-5661-4712-b84a-1ba4f1e47771}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>120</width>
  <height>30</height>
  <uuid>{3fa334fa-0646-437a-89d1-e6b53bd7c1ee}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>120</width>
  <height>30</height>
  <uuid>{cd4dde52-3326-4f78-b905-f389aac73a9f}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
 ...
 <bsbObject version="2" type="BSBLineEdit">
  ...
  <width>330</width>
  <height>28</height>
  <uuid>{d0c73426-7504-4397-856f-20649aa7a5c8}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
 ...
 <bsbObject version="2" type="BSBButton">
  ...
  <width>170</width>
  <height>30</height>
  <uuid>{064f423b-4026-4573-8baf-76f3460def13}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <type>value</type>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>330</width>
  <height>30</height>
  <uuid>{36ba8ef2-ab45-4273-a97b-52d1eb1034b3}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>Restart the instrument after changing the audio file.</label>
