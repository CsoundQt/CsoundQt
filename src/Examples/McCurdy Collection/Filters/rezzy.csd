...
;	'Filter_Cutoff' limited to 10000 Hz to avoid inf values for high 'Resonance' values
...
instr	1	;GUI
	...
	if (ktrig == 1)	then
		...
		gkfco		tablei	kfco, giExp10000, 1
...
instr	2
	...
	aresR		rezzy 	asigR, kfco, gkres , i(gkmode), i(gkskip)
				rireturn
				outs		aresL * gkamp, aresR * gkamp									;SEND FILTER OUTPUT TO THE AUDIO OUTPUTS AND SCALE USING THE FLTK SLIDER DERIVED VARIABLE gkamp 													;RETURN FROM REINITIALISATION PASS TO PERFORMANCE TIME PASSES
endin
</CsInstruments>
<CsScore>
