...
instr	2
	gkNumInstr1	active 	1								;SENSE THE NUMBER OF NOTES THAT ARE BEING PLAYED BY INSTR 1
	if	gkNumInstr1!=0	kgoto	KEEP_PLAYING					;IF INSTR 1 IS PLAYING AT LEAST ONE NOTE THEN INSTR 2 MUSTN'T TURN ITSELF OFF
	...
	kgliss		linseg	0, (.00001), 1, (1), 1				;RAMPING UP VARIABLE
	kgliss		=		kgliss * gkgliss					;GLISSANDO VALUE TAKEN FROM FLTK VALUATOR AND MULTIPLIED TO THE RAMPING UP VARIABLE
	kcps			portk	gkcps, kgliss						;APPLY PORTAMENTO TO PITCH VARIABLE
	...
	;ANTI-CLICK ENVELOPE;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	kanticlick	linsegr	0, .001, 1, .001, 0
	...
	asig			vco	gkamp*kanticlick*gktrm, kcps*gkvib*kPEnv*gkbendmlt, i(gkwave), kpw, ifn, imaxd, i(gkleak), i(gknyx);, 0, 0
	goto	ESCAPE1		;JUMP TO LABEL 'ESCAPE1'
	
	;GBUZZ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	SKIP1:			;LABEL 'SKIP1'
	;OUTPUT	OPCODE	AMPLITUDE               |         FREQUENCY         | NO.OF_HARMONICS | LOWEST_HARMONIC | POWER | FUNCTION_TABLE
	asig		gbuzz 	gkamp*kanticlick*gktrm,    kcps*gkvib*kPEnv*gkbendmlt,      gkharm,            gklh,        gkmul,       2
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
<bsbPanel>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midicc>0</midicc>
  <label>-------------------------------------------------------------------------------------------------------------------------
Building upon the principles of the previous example, 'Basic MonophonicSynth.csd', to create a MIDI controlled monophonic instrment, this example provides more user control of amplitude, filter and pitch envelopes. A variety of waveforms can be selected for use by the audio oscillator - three of them derive from the VCO opcode and a fourth derives from the gbuzz opcode. Low frequency modulation of the oscillator can be a user defined combination of tremolo (amplitude modulation) and vibrato (pitch modulation). The amount of modulation can be varied using MIDI controller 1 (the modulation wheel on a MIDI keyboard.
...
Additionally the signal is passed through a stereo ping-pong delay. Pitch bend is implemented, the depth of which can be set by the user in the interface.</label>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>Monophonic MIDI Synth</label>
  <alignment>center</alignment>
  <font>Liberation Sans</font>
  <fontsize>18</fontsize>
  <precision>3</precision>
