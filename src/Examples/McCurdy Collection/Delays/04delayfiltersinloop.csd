...
instr	1	;PLAYS FILE
	if	gkinput==0	then										;IF INPUT '808loop.wav' IS SELECTED...
		...
		gasigL, gasigR	diskin2	Sfile, 1, 0, 1						;GENERATE 2 AUDIO SIGNALS FROM A STEREO SOUND FILE (NOTE THE USE OF GLOBAL VARIABLES)		
	else														;OTHERWISE
...
These were frequently used in Dub Reggae. In this example the user can choose between a drum loop sound file as input or the computer's live input. A gain control is provided to control the gain of the live input.</label>
  <alignment>left</alignment>
  <font>Arial</font>
